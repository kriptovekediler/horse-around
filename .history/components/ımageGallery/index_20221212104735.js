    ...
    <div className="w-full">
      ...
      {show && (
        <div className="w-full center justify-center  absolute top-8 items-center left-0 content-center flex h-screen">
          ...
          >
            <h2 className="bg-yellow-400 font-bold text-xl text-white items-start justify-start z-50  float-right text-center cursor-pointer rounded-3xl pt-1.5 pb-1.5 pr-3 pl-3 ">
              X
            </h2>
          </div>
          ...
          <img
            ...
            className="fixed  items-center justify-center z-40 "
          />
        </div>
      )}
    </div>
