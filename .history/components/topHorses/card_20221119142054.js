  ...
  return (
    <div className={styles.cardBox}>
      ...
      <div className={styles.topHorseInfoBox}>
        <Image src={horse?.image} width={100} height={50} objectFit="cover" className={styles.horseInfoImg} />
        <div className={styles.horseInfo}>
          ...
          <div className="flex w-full justify-between items-end shrink-0">
            <span className={styles.horseName}>{web3?.utils.fromWei(horse?.saleHistory[horse?.saleHistory.length - 1].price,'ether')} ETH or {web3?.utils.fromWei(horse?.saleHistory[horse?.saleHistory.length - 1].price,'ether') * 1500} $ </span>
