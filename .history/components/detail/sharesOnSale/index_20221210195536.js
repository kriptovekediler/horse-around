...
export default function SharesOnSale({ horse }) {
  ...
  console.log("Sale Info:", horse?.saleInfo[0]?.sellerAddress);
  ...
  const buyItem = async (e, id) => {
    ...
    //   "0x7e0bD113aBd63068fe475fca7456c0dB8e79EbFC",
    //   horse?.horseId,
    //   leftAmount,
    //   "0xA0c1c14a878aDbb3675F58eD1878076f56177749",
    //   horse?.saleInfo[0]?.sellerAddress
    // );
