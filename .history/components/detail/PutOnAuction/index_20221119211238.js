...
export default function PutOnAuction({ horse }) {
  ...
  const endAuction = async (e, horse) => {
    ...
    await contractAuction?.methods
      ...
      .then((res) => {
        ...
        axios
          .post("https://horseaorund-server.herokuapp.com/end_auction", {
            buyer:
  ...
  const getNonce = async () => {
    const user = await axios.post(
      "https://horseaorund-server.herokuapp.com/get_user",
      {
  ...
  const submit = async (e) => {
    ...
    await axios
      .post("https://horseaorund-server.herokuapp.com/put_on_auction", {
        publicAddress: account.data,
        horseId: horse.horseId,
  ...
  const remove = async () => {
    ...
    await axios
      .post("https://horseaorund-server.herokuapp.com/remove_from_auction", {
        horseId: horse.horseId,
        publicAddress: account.data,
      })
      .then((res) => {
