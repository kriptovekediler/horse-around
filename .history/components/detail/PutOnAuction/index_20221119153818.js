...
export default function PutOnAuction({ horse }) {
  ...
  const endAuction = async (e, horse) => {
    ...
    await contractAuction?.methods
      ...
      .then((res) => {
        ...
        axios
          .post("https://horse-around-backend.herokuapp.com/end_auction", {
            buyer:
  ...
  const submit = async (e) => {
    ...
    await axios
      .post("https://horse-around-backend.herokuapp.com/put_on_auction", {
        publicAddress: account.data,
        horseId: horse.horseId,
  ...
  const remove = async () => {
    ...
    await axios
      .post("https://horse-around-backend.herokuapp.com/remove_from_auction", {
        horseId: horse.horseId,
        publicAddress: account.data,
      })
      .then((res) => {
