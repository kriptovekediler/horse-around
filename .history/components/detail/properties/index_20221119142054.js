        ...
        <div className="border-r-2 border-[#FFFFFF1A] pr-20 sm:pr-0 md:pr-0 md:border-0 sm:border-0 md:mb-10 sm:mb-10">
          ...
          <div>
            <div className={styles.propertiesItem}>
              ...
              <span className={styles.propertiesValue}>{horse.breederName}</span>
            </div>
            <div className={styles.propertiesItem}>
            ...
            <div className={styles.propertiesItem}>
              ...
              <span className={styles.propertiesValue}>{horse.horseOwnerBonus} $</span>
            </div>
            <div className={styles.propertiesItem}>
              <span className={styles.propertiesName}>Breeding Bonus</span>
              <span className={styles.propertiesValue}>{horse.breedingBonus} $</span>
            </div>
            <div className={styles.propertiesItem}>
              <span className={styles.propertiesName}>Overseas Bonus</span>
              <span className={styles.propertiesValue}>{horse.overseasBonus} $</span>
            </div>
            <div className={styles.propertiesItem}>
              <span className={styles.propertiesName}>
                Sponsorship Earnings
              </span>
              <span className={styles.propertiesValue}>{horse.sponsorshipEarnings} $</span>
            </div>
          </div>
        </div>
        <div>
          ...
          <div> 
            ...
            <div className={styles.documentItems}>
              ...
              <span className={styles.documentDate}>24.06.2022</span>
              <button className={styles.downloadButton}>
                Download <DownloadIcon className="text-sm 2xl:text-2xl hover:fill-goldMetallic" />
              </button>
            </div>
          </div>
        </div>
