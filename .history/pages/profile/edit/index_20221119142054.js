...
/*     reader.readAsArrayBuffer(tempData);
  ...
  const updateUser = async (e) => {
    ...
    await axios({
      method: 'post',
      url: 'https://horse-around-backend.herokuapp.com/update_user/',
      data: formData,
      headers: {
...
/*     await axios.post("https://horse-around-backend.herokuapp.com/update_user/", {
      user_info: user,
      file: data,
          ...
          <div className="grid grid-cols-4 gap-20 text-white">
            ...
            <div className="col-span-3">
              ...
              <form className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-6">
                  <Input text="Surname" placeholder="John" 
                  onChange={(e) => setUser({ ...user, surname: e.target.value })}
                  />
                </div>
                <div className="col-span-6">
                  <Input text="Username" placeholder="John" 
                ...
                <div className="col-span-12">
                  <Input text="Bio" placeholder="Type your bio..." 
                ...
                <div className="col-span-6">
                  <SelectBox text="Location" options={options} 
                  value={user.location.label} onChange={changeHandler}
                  />
                </div>
                <div className="col-span-12">
                  <FileUpload
                ...
                <div className="col-span-6">
                  <ToogleCheckbox text="Private Account" 
                  onChange={(e) => setUser({ ...user, private: e.target.checked })}
                  />
                </div>
                <div className="col-span-6 text-right">
                  <Button 
                    onClick={(e) => {updateUser(e), setLoadingModal(true)}}
                  >Save Changes</Button>
                </div>
              </form>
            </div>
