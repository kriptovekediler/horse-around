            ...
            <div className="col-span-9 text-white">
              ...
              {activeTab === "Horse" && (
                <div className="grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1  gap-4 mt-10">
                      ...
                      <Link href={`/detail/${value.horseId}`}>
                        <a>
                          <HorseCard
                            ...
                            price={
                              value.saleInfo[value?.saleInfo?.length - 1]?.price
                            }
                            id={value?.id}
                            key={key}
                          />
                  ...
                  <Link href={`/detail/${horses.horseId}`}>
                    <a>
                      <HorseCard
                        name={horses?.horseName}
                        image={horses?.image}
                        ownerName={horses?.ownerName}
                        ownerAddress={horses?.publicAddress}
                        price={
                          horses.saleInfo[horses?.saleInfo?.length - 1]?.price
                        }
                        id={horses?.id}
                        key={key}
                      />
